export const en = {
  ...
  comparison: {
    title: 'LMC Reference vs CPU Measured',
    ...
    measurementWarning: 'CPU time is measured in the browser. For very small programs, browser, JIT, and timer overhead may have a large impact, making the CPU appear slower than the LMC.',
