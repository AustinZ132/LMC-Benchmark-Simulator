export const en = {
  ...
  comparison: {
    title: 'Reference Model Comparison',
    runComparison: 'Run Comparison',
    lmc: 'LMC Reference Model',
    modern: 'CPU Reference Model',
    clockSpeed: 'Clock Speed',
    executionTime: 'Estimated Time',
    referenceTime: 'Reference Model Time',
    instructions: 'Instructions',
    memoryAccess: 'Memory Access',
    cache: 'Cache',
    pipeline: 'Pipeline',
    samples: 'JS Samples',
    jsMeasuredAvg: 'JS Measured Avg',
    branchPrediction: 'Branch Prediction',
    outOfOrder: 'Out-of-Order',
    speedup: 'Speedup',
    whyFaster: 'Why modern CPUs are faster',
    referenceNote: 'Both sides use the same 2.3GHz reference clock, so the ratio comes from model cycles rather than browser timing noise.',
    yourCpuIs: 'CPU reference model is',
    fasterThanLmc: 'faster than the LMC reference model',
    reasons: {
