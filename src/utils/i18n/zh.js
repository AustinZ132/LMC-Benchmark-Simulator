export const zh = {
  ...
  comparison: {
    ...
    referenceNote: '两边都使用同一个 2.3GHz 参考频率，因此倍数来自模型周期数，而不是浏览器计时波动。',
    yourCpuIs: 'CPU reference model',
    fasterThanLmc: '快于 LMC reference model',
    reasons: {
